...
def run(
        ...
        source=ROOT / 'data/images/10.png',  # file/dir/URL/glob/screen/0(webcam)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        annotator.box_label(xyxy, label, dataLabel, color=colors(c, True))
                    if save_crop:
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'run/train/exp3/best.pt', help='model path or triton URL')
